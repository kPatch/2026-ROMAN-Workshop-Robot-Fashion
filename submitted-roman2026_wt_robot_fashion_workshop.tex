...
\begin{center}
  {\fontsize{14}{16}\selectfont A Workshop/Tutorial proposal for the\par}
  {\fontsize{18}{21}\selectfont\bfseries 35th IEEE International Conference on Robot and Human Interactive Communication (RO-MAN 2026)\par}
  \vspace{0.6em}
  {\fontsize{12}{14}\selectfont August 24--28, 2026 / Kitakyushu International Conference Center, Kitakyushu, Japan\par}
\end{center}

\FormSection{Title}
\textbf{Robot Fashion: Designing Wearable Identities Across Robot Morphologies} (\textbf{RoboFashion})
...
\OrganizerBlock
  ...
  {Lead author of the HRI~'26 paper \textit{Robot Fashion: The Social Psychology of Robot Clothing} and proposer of the Robot Fashion Psychology Model (RFPM), linking robot attire to trust calibration, role expectations, and touch norms across morphologies. PhD Candidate at Kent State University's Advanced Telerobotics Research Lab, translating fashion-led research-through-design (in-the-wild exemplars and a morphology-diverse capsule collection) into morphology-aware garment guidelines and hands-on workshop activities. Previously a researcher at NASA and led Blockchain Strategy at Goldman Sachs; currently a Research Fellow at Mysten Labs.}
...
\FormBlockSep
\textbf{Reviewer note:} This paper will be published at the upcoming HRI~2026 conference; for convenience, an early copy of the full paper is available at \href{https://drive.google.com/file/d/1AIuIYJQ4n4JE4gugdnk1P_0qJRBY-Ale}{https://drive.google.com/file/d/1AIuIYJQ4n4JE4gugdnk1P\_0qJRBY-Ale}.
